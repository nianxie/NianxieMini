...
namespace TMPro
{
        ...
        IScrollHandler
    {
        ...
        [SerializeField]
        protected TMPModify_ShellFont m_GlobalShellFont;
        [SerializeField]
        ...
        public void SetGlobalFont(TMPModify_ShellFont shellFont, TMP_FontAsset fontAsset, bool updateLabel=false)
        {
            TMP_Text placeholderTextComponent = m_Placeholder as TMP_Text;

            if (placeholderTextComponent != null) placeholderTextComponent.SetFont(shellFont, fontAsset);
            textComponent.SetFont(shellFont, fontAsset);
            if (updateLabel)
            {
                UpdateLabel();
            }
