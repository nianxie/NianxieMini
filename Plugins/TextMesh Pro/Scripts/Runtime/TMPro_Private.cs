    ...
    public partial class TextMeshPro
    {
        ...
        void ON_MATERIAL_PROPERTY_CHANGED(bool isChanged, Material mat)
        {
            ...
            if (m_renderer.sharedMaterial == null)
            {
                ...
                {
                    m_renderer.sharedMaterial = realFontAsset.material;
                    Debug.LogWarning("No Material was assigned to " + name + ". " + realFontAsset.material.name + " was assigned.", this);
                }
                else
        ...
        protected override void LoadFontAsset()
        {
            ...
            {
                if (m_sharedMaterial != m_shellFont.material)
                {
