...
namespace TMPro.EditorUtilities
{
    ...
    public class TMP_InputFieldEditor : SelectableEditor
    {
        ...
        SerializedProperty m_GlobalShellFont;
        ...
        protected override void OnEnable()
        {
            ...
            m_GlobalShellFont = serializedObject.FindProperty("m_GlobalShellFont");
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (m_foldout.fontSettings)
            {
                ...
                EditorGUILayout.PropertyField(m_GlobalShellFont, new GUIContent("Shell Font ", "Set shell Font, shell font will not be packed into asset bundle."));
                var shellFont = m_GlobalShellFont.objectReferenceValue;
                if (shellFont != null)
                {
                    m_GlobalFontAsset.objectReferenceValue = null;
                ...
                if (EditorGUI.EndChangeCheck())
                {
                    ...
                    inputField.SetGlobalFont(m_GlobalShellFont.objectReferenceValue as TMPModify_ShellFont, m_GlobalFontAsset.objectReferenceValue as TMP_FontAsset);
                }
