...
namespace TMPro.EditorUtilities
{
    ...
    public class TMP_SettingsEditor : Editor
    {
        ...
        SerializedProperty m_PropRawShellFonts;
        ...
        public void OnEnable()
        {
            ...
            m_PropRawShellFonts = serializedObject.FindProperty("m_rawShellFonts");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_PropRawShellFonts);
